    ...
    return (
        <section id="home" className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-96' ref={ref}>
            ...
            >
                ...
                <a href="/Resume-Aryan_Saxena.pdf" download={true} className=' group flex items-center justify-center gap-2 bg-white px-7 py-3 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10'>Download Resumé <HiDownload className='opacity-60 group-hover:translate-y-1 transition '/></a>
